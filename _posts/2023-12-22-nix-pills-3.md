...
## Kanäle
Bei vielen Paketmanagern können Anwender die Frage ausblenden, von welchen Quellen Paketen installiert werden. Demgegenüber expliziert Nix diesen Aspekt über das Konzept der *Kanäle* (*channels*).[^flakes] Kanäle zeigen auf Branches von Paket-Repositories. Sie enthalten Paket-*Definitionen*, *Derivations* im Nix-Jargon.
